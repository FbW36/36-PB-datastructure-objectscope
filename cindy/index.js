...
console.log("Task 2  ==> ", student2.getObjectValues());
// Bonus

//     Write a method to get the length of the person object=> pending! 
console.log("students length! => ", Object.keys(student))//Done it <= 